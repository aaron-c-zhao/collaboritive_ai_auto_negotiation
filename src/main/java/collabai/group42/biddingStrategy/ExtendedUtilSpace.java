 ...
 * class may change in the future, use at your own risk. Copy of
 * geniusweb.exampleparties.timedependentparty
 *
 */
public class ExtendedUtilSpace {
	...
	/**
	 * @param utilityGoal the intended utilty
	...
	/**
	 * Get utility value of a certain bid.
	 *
	 * @param bid the bid to get the utility value.
